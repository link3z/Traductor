...
#Region " DECLARACIONES "
    ''' <summary>
    ''' Traductores de la aplicación (para la propia traducción y para el uso)
    ''' </summary>
    Private iTraductorGenerar As cTraductorPO
    Private iTraductorUsar As cTraductorPO
#End Region
...
#Region " CONSTRUCTORES Y CARGA "
    Private Sub frmPRINCIPAL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For Each unIdioma As cIdioma In iTraductorUsar.Idiomas
            ...
            indice += 1
            If unIdioma.Id = enmLenguajesCodigos.es_ES Then cmbIdiomaVentana.SelectedItem = nuevoItem
        Next
