...
#Region " PROPIEDADES "
    ...
    Public Overrides ReadOnly Property Tipo As motorTraduccion
        Get
            Return motorTraduccion.OpenTrad
        End Get
    End Property
    ...
    Public ReadOnly Property URI As String Implements IMotorTraduccion.URI
        ...
        End Get
    End Property
    Private iURI As String = "http://opentrad.com/webservices/urlTranslate.php?marcar=&direccion=@entrada@-@salida@&inurl=http%3A%2F%2F@URI@"
